	...
	<div class="col-md-4">
		...
		<div class="card">
			...
			<div class="card-body">
              ...
              <center><button type="submitt" class="btn btn-danger" onclick="window.print('card')"> PDF </button>
                    ...
                    <div id="qrcode-container" style="display: none;">
                        <center><img src="QRCODE/QRcode.jpeg"alt="UPI QR Code "style="height:200px;"></center>
                    </div>

                    <center><button type="submit" name="payment_bill" class="btn btn-primary" style="background-color:green">Payment</button></center>
                    <script>
